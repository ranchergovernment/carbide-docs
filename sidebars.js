...
const sidebars = {
  // The Carbide docs use a single, manually-curated sidebar so we can express
  // the nested Installation → Seeding → Connected/Airgapped structure that an
  // autogenerated sidebar can't. This is the authoritative navigation.
  carbideSidebar: [
    'intro',
    {
      type: 'category',
    ...
    {
      type: 'category',
      label: 'Rancher Compliance Operator',
      collapsed: false,
      items: [
